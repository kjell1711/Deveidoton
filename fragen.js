const configData = {
    questions: {
      ...
      deutsch: [
        { question: "Was ist das Subjekt im Satz: 'Der Hund läuft im Park.'?", answers: ["Der Hund", "läuft", "im Park"], correct: 0 },
        { question: "Bestimme das Objekt im Satz: 'Maria gibt ihrem Bruder ein Geschenk.'", answers: ["Maria", "gibt", "ein Geschenk"], correct: 2 },
        { question: "Welche Funktion hat der Satzteil 'im Sommer' im Satz: 'Im Sommer gehen wir oft wandern.'?", answers: ["Subjekt", "Prädikat", "adverbiale Bestimmung der Zeit"], correct: 2 },
        { question: "Wie lautet das Prädikat im Satz: 'Die Schüler schreiben die Prüfung.'?", answers: ["Die Schüler", "schreiben", "die Prüfung"], correct: 1 },
